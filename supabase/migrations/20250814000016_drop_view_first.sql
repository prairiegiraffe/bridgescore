...
RAISE NOTICE 'Dropped organization_details view';

-- STEP 3: Migrate is_demo to demo_mode if needed
UPDATE organizations 
SET demo_mode = true 
WHERE is_demo = true AND demo_mode = false;

-- STEP 4: Now we can safely drop the is_demo column
ALTER TABLE organizations DROP COLUMN is_demo;

-- STEP 5: Recreate the view with only demo_mode
